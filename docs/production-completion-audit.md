...
Generated: 2026-06-26T15:30:59.486Z
...
| Create a local mobile app artifact for phone testing | `complete_local` | `npm run android:apk:local`<br>`npm run android:artifact:check`<br>`/Users/jkv6333/Desktop/SoulGuru/SoulGuru-debug.apk` (6.7 MB, SHA-256 `4f3b9ce44e182c298bbca85fa9690511574f64ca9a5dcf0c62baf3b3008545ce`) | Build production APK only after `VITE_API_BASE_URL` points at the production HTTPS domain. |
