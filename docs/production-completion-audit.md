...
Generated: 2026-06-26T14:41:52.192Z
...
| Create a local mobile app artifact for phone testing | `complete_local` | `npm run android:apk:local`<br>`npm run android:artifact:check`<br>`/Users/jkv6333/Desktop/SoulGuru/SoulGuru-debug.apk` (6.7 MB, SHA-256 `bfd7f573131adf0b579b269b12ece1bf5a898b87bfa08559b96d3092eeb5c5c7`) | Build production APK only after `VITE_API_BASE_URL` points at the production HTTPS domain. |
