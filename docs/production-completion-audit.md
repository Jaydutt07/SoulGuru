...
Generated: 2026-06-26T14:56:11.136Z
...
| Create a local mobile app artifact for phone testing | `complete_local` | `npm run android:apk:local`<br>`npm run android:artifact:check`<br>`/Users/jkv6333/Desktop/SoulGuru/SoulGuru-debug.apk` (6.7 MB, SHA-256 `cec807ec79a959e4a3366b82a100491c0c7234dead1b7d0b93b78a73e79f4393`) | Build production APK only after `VITE_API_BASE_URL` points at the production HTTPS domain. |
