...
- Soul Guru v17 daily wisdom prompt with private reading fingerprints, shared client/backend cache versioning, surface-rhythm repair checks, whole-sentence cache refreshes, structure-similarity gates, and real lunar mansion/tithi timing
