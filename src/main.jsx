...
const SOUL_READING_CACHE_VERSION = "soul-wisdom-v13";
const SOUL_READING_CACHE_PREFIX = "soulguru.dailySoulReading.v13";
const SOUL_READING_HISTORY_PREFIX = "soulguru.dailySoulReadingHistory.v13";
