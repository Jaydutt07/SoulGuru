...
const SOUL_READING_CACHE_VERSION = "soul-wisdom-v9";
const SOUL_READING_CACHE_PREFIX = "soulguru.dailySoulReading.v9";
const SOUL_READING_HISTORY_PREFIX = "soulguru.dailySoulReadingHistory.v9";
