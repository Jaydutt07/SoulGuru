...
const SOUL_READING_CACHE_VERSION = "soul-wisdom-v11";
const SOUL_READING_CACHE_PREFIX = "soulguru.dailySoulReading.v11";
const SOUL_READING_HISTORY_PREFIX = "soulguru.dailySoulReadingHistory.v11";
